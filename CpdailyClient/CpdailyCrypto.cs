...
namespace Cpdaily
{
    internal static class CpdailyCrypto
    {
        ...
        public static byte[] DESDecrypt(byte[] encryptedValue, byte[] key, byte[] iv)
        {
            ...
            return cryptoTransform.TransformFinalBlock(encryptedValue, 0, encryptedValue.Length);
        }
        ...
        public static byte[] DESEncrypt(byte[] originalValue, byte[] key, byte[] iv)
        {
            ...
            return cryptoTransform.TransformFinalBlock(originalValue, 0, originalValue.Length);
        }
        ...
        /// <summary>
        /// 反编译自 cpdaily.apk, 尚不清楚和寻常 Base64 是否有区别
        /// </summary>
